...
def test_akismet_parameters(constance_config, mock_requests, spam_request):
    ...
    form = AkismetContentTestForm(spam_request,
...
def test_akismet_key_set(constance_config, mock_requests, spam_request,
                         key_set):
...
@pytest.mark.parametrize('check_response',
                         (b'true', b'yada yada'),
                         ids=('spam', 'error'))
def test_akismet_check_invalid(constance_config, mock_requests, spam_request,
                               check_response):
