    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('event_type', models.IntegerField(blank=True, choices=[(1, 'Password Changed'), (2, 'Profile Changed'), (3, 'Subscription Changed'), (4, 'Profile Deleted')], default='')),
                ('status', models.IntegerField(choices=[(1, 'Processed'), (2, 'Pending'), (3, 'Ignored'), (4, 'Not Implemented')], default=2)),
