...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('user_profiles', (
            ...
            ('locale', self.gf('kuma.core.models.LocaleField')(default='en-US', max_length=7, null=True, db_index=True, blank=True)),
    ...
    models = {
        ...
        'users.userprofile': {
            ...
            'locale': ('kuma.core.models.LocaleField', [], {'default': "'en-US'", 'max_length': '7', 'null': 'True', 'db_index': 'True', 'blank': 'True'}),
