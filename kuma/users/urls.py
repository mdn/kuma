...
account_patterns = patterns('',
    ...
    url(r'^connections/?$', socialaccount_views.connections,
        name='socialaccount_connections'),
    url(r'^inactive/?$', account_views.account_inactive,
        name='account_inactive'),
    url(r'^email/?$', account_views.email, name='account_email'),
    url(r'^email/confirm/?$', account_views.email_verification_sent,
