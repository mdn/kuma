...
class StrippedCharField(forms.CharField):
    ...
    def __init__(self, max_length=None, min_length=None, *args, **kwargs):
        ...
        for validator in self.validators:
            ...
            if class_name == "MinLengthValidator" or class_name == "MaxLengthValidator":
...
class BaseValidator(validators.BaseValidator):
    ...
    def __call__(self, value):
        ...
        params = {
            "limit_value": _format_decimal(self.limit_value),
...
class MinLengthValidator(validators.MinLengthValidator, BaseValidator):
    message = _(
        "Ensure this value has at least %(limit_value)s "
...
class MaxLengthValidator(validators.MaxLengthValidator, BaseValidator):
    message = _(
        "Ensure this value has at most %(limit_value)s "
        "characters (it has %(show_value)s)."
    )
