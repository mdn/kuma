...
class Command(ScrapeCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            "urls", metavar="URL_OR_PATH", nargs="+", help="URL or path to a wiki page"
        )
        parser.add_argument(
            "--force", help="Update existing Document record", action="store_true"
        )
        parser.add_argument(
            "--revisions",
            dest="revisions",
        ...
        parser.add_argument(
            ...
            dest="depth",
            metavar="DEPTH",
            type=self.int_all_type,
            default=0,
            help=("Depth in the topic tree to scrape" ' ("all" for all)'),
        )
    ...
    def handle(self, *arg, **options):
        ...
        for url in options["urls"]:
            ...
            if source.state == source.STATE_ERROR:
                ...
                self.stderr.write(
                    'Document "%s" already exists. Use --force to update.' % path
                )
