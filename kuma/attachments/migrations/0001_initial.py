...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_table('wiki_documentattachment', 'attachments_documentattachment')
        db.rename_table('wiki_attachment', 'attachments_attachment')
        db.rename_table('wiki_attachmentrevision', 'attachments_attachmentrevision')

    def backwards(self, orm):
        db.rename_table('attachments_documentattachment', 'wiki_documentattachment')
        db.rename_table('attachments_attachment', 'wiki_attachment')
        db.rename_table('attachments_attachmentrevision', 'wiki_attachmentrevision')
    ...
    models = {
        ...
        'attachments.documentattachment': {
            'Meta': {'object_name': 'DocumentAttachment', 'db_table': "'wiki_documentattachment'"},
