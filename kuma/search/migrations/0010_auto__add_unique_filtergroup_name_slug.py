...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'FilterGroup', fields ['name', 'slug']
        db.create_unique('search_filtergroup', ['name', 'slug'])

    def backwards(self, orm):
        # Removing unique constraint on 'FilterGroup', fields ['name', 'slug']
        db.delete_unique('search_filtergroup', ['name', 'slug'])
    ...
    models = {
        ...
        'search.filtergroup': {
            'Meta': {'ordering': "('-order', 'name')", 'unique_together': "(('name', 'slug'),)", 'object_name': 'FilterGroup'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
