...
def test_document_get_hreflang_with_other_locales(root_doc, locales, expected_results):
...
def test_build_json_data_unsaved_doc():
    ...
    """
    doc = Document(
        slug="NewDoc", title="New Doc", uuid="765203ea-c5b8-4385-a551-26c1ef9fc843"
    )
