...
KumaScriptToolbox = namedtuple(
    "KumaScriptToolbox", "errors errors_as_headers macros_response"
)
...
@pytest.fixture
def root_doc_with_mixed_contributors(
    root_doc, wiki_user, wiki_user_2, inactive_wiki_user, banned_wiki_user
):
    """
...
def ks_toolbox():
        ...
        "logs": [
            {
                ...
                "args": [
                    "TestError",
                    {},
                    {"name": "SomeMacro", "token": {"args": "arguments here"}},
                ],
    ...
    macros_response = {
        "json": {
            ...
            "macros": [
                {"name": "SomeMacro", "filename": "SomeMacro.ejs"},
                {"name": "SomeMacro2", "filename": "SomeMacro2.ejs"},
            ],
        },
