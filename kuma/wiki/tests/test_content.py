...
class BugizeTests(TestCase):
    def test_bugize_text(self):
        ...
        good = 'Fixing <a href="https://bugzilla.mozilla.org/show_bug.cgi?id=12345" target="_blank" rel="noopener noreferrer">bug 12345</a> again. &lt;img src=&#34;http://davidwalsh.name&#34; /&gt; &lt;a href=&#34;&#34;&gt;javascript&gt;&lt;/a&gt;'
        assert bugize_text(bad) == Markup(good)

        bad_upper = 'Fixing Bug #12345 again.'
        good_upper = 'Fixing <a href="https://bugzilla.mozilla.org/show_bug.cgi?id=12345" target="_blank" rel="noopener noreferrer">Bug 12345</a> again.'
