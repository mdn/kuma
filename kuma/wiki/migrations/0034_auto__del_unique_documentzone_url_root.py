...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'DocumentZone', fields ['url_root']
        db.delete_unique('wiki_documentzone', ['url_root'])


    def backwards(self, orm):
        # Adding unique constraint on 'DocumentZone', fields ['url_root']
        db.create_unique('wiki_documentzone', ['url_root'])
