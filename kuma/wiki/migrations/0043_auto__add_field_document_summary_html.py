...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Document.summary_html'
        db.add_column('wiki_document', 'summary_html',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Document.summary_html'
        db.delete_column('wiki_document', 'summary_html')
