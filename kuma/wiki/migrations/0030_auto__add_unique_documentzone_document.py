...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'DocumentZone', fields ['document']
        db.create_unique('wiki_documentzone', ['document_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'DocumentZone', fields ['document']
        db.delete_unique('wiki_documentzone', ['document_id'])
