...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Document', fields ['deleted']
        db.create_index('wiki_document', ['deleted'])


    def backwards(self, orm):
        # Removing index on 'Document', fields ['deleted']
        db.delete_index('wiki_document', ['deleted'])
