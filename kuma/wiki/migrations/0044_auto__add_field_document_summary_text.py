...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Document.summary_text'
        db.add_column('wiki_document', 'summary_text',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Document.summary_text'
        db.delete_column('wiki_document', 'summary_text')
