...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DocumentZone.url_root'
        db.add_column('wiki_documentzone', 'url_root',
                      self.gf('django.db.models.fields.CharField')(db_index=True, max_length=255, unique=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DocumentZone.url_root'
        db.delete_column('wiki_documentzone', 'url_root')
    ...
    models = {
        ...
        'wiki.documentzone': {
            ...
            'url_root': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '255', 'unique': 'True', 'null': 'True', 'blank': 'True'})
        },
        'wiki.editortoolbar': {
