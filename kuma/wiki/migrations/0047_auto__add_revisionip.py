...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'RevisionIP'
        db.create_table('wiki_revisionip', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('revision', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['wiki.Revision'])),
            ('ip', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=40, null=True, blank=True)),
        ))
        db.send_create_signal('wiki', ['RevisionIP'])


    def backwards(self, orm):
        # Deleting model 'RevisionIP'
        db.delete_table('wiki_revisionip')
    ...
    models = {
        ...
        'wiki.revisionip': {
            'Meta': {'object_name': 'RevisionIP'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'ip': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '40', 'null': 'True', 'blank': 'True'}),
            'revision': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['wiki.Revision']"})
        },
        'wiki.taggeddocument': {
