...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Revision.render_max_age'
        db.add_column('wiki_revision', 'render_max_age',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Revision.render_max_age'
        db.delete_column('wiki_revision', 'render_max_age')
