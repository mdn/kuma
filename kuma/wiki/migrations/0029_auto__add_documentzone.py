...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DocumentZone'
        db.create_table('wiki_documentzone', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('document', self.gf('django.db.models.fields.related.ForeignKey')(related_name='zones', to=orm['wiki.Document'])),
            ('styles', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal('wiki', ['DocumentZone'])


    def backwards(self, orm):
        # Deleting model 'DocumentZone'
        db.delete_table('wiki_documentzone')
    ...
    models = {
        ...
        'wiki.documentzone': {
            ...
            'document': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'zones'", 'to': "orm['wiki.Document']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
