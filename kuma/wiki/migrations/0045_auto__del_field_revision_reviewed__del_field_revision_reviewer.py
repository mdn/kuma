...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Revision.reviewed'
        db.delete_column('wiki_revision', 'reviewed')

        # Deleting field 'Revision.reviewer'
        db.delete_column('wiki_revision', 'reviewer_id')


    def backwards(self, orm):
        # Adding field 'Revision.reviewed'
        db.add_column('wiki_revision', 'reviewed',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Adding field 'Revision.reviewer'
        db.add_column('wiki_revision', 'reviewer',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='reviewed_revisions', null=True, to=orm['auth.User']),
                      keep_default=False)
