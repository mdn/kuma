...
from .jobs import DocumentCodeSampleJob, DocumentContributorsJob, DocumentTagsJob
...
@receiver(
    post_save, sender=DocumentSpamAttempt, dispatch_uid="wiki.spam_attempt.post_save"
)
