...
def get_seo_description(content, locale=None, strip_markup=True):
    ...
    if content:
        ...
        # Note, PyQuery is magically clumsy in that it will try download
        # it if the first and only argument looks like a URL.
        # It does that my looking for args[0] being a string and
        # containing 'http://' or 'https://'.
        # Let's pre-emptively make that same check ourselves and if this
        # 'content' appears to be a URL, don't even bother with any of this
        # because we don't want PyQuery to attempt to open the URL. It
