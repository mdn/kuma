...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('demos_submission', (
            ...
            ('launches_total', self.gf('django.db.models.fields.IntegerField')(default=0, db_index=True, blank=True)),
            ('launches_recent', self.gf('django.db.models.fields.IntegerField')(default=0, db_index=True, blank=True)),
        ))
        db.send_create_signal('demos', ['Submission'])
