...
zone_redirects = (
    ('Add-ons', 'Mozilla/Add-ons', ('ar', 'bn', 'ca',
                                    'de', 'en-US', 'es', 'fa',
                                    'fr', 'hu', 'id', 'it', 'ja',
    ...
    ('Firefox', 'Mozilla/Firefox', ('ar', 'bm', 'ca',
                                    'de', 'el', 'en-US', 'es',
                                    'fi', 'fr',
                                    'he', 'hi-IN', 'hu', 'id',
                                    'it', 'ja', 'ko',
    ...
    ('Apps', 'Web/Apps', ('en-US', 'fa', 'fr', 'ja', 'th', 'zh-CN',
                          'zh-TW', None)),
...
external_redirect = partial(locale_redirect, re_flags='i',
                            prepend_locale=False, permanent=True)

marionette_redirectpatterns = [
    external_redirect(r'docs/(?:Mozilla/QA/)?Marionette$',
                      marionette_docs_root_url + 'index.html'),
    external_redirect(r'docs/(?:Mozilla/QA/)?Marionette/Builds$',
                      marionette_docs_root_url + 'Building.html'),
    external_redirect(r'docs/(?:Mozilla/QA/)?Marionette/Client$',
                      marionette_client_docs_url),
    external_redirect(r'docs/Mozilla/QA/Marionette/Python_Client$',
                      marionette_client_docs_url),
    external_redirect(r'docs/(?:Mozilla/QA/)?Marionette/Developer_setup$',
                      marionette_docs_root_url + 'Contributing.html'),
    external_redirect(r'docs/Marionette_Test_Runner$',
                      marionette_docs_root_url + 'PythonTests.html'),
    external_redirect(r'docs/Mozilla/QA/Marionette/Marionette_Test_Runner$',
                      marionette_docs_root_url + 'PythonTests.html'),
    external_redirect(r'docs/(?:Mozilla/QA/)?Marionette/(?:MarionetteTestCase'
                      r'|Marionette_Python_Tests|Running_Tests|Tests)$',
                      marionette_docs_root_url + 'PythonTests.html'),
    external_redirect(r'docs/Mozilla/QA/Marionette/Protocol$',
                      marionette_docs_root_url + 'Protocol.html'),
    external_redirect(r'docs/Mozilla/QA/Marionette/WebDriver/status$',
                      'https://bugzilla.mozilla.org'
                      '/showdependencytree.cgi?id=721859&hide_resolved=1'),
    external_redirect(r'docs/Marionette/Debugging$',
