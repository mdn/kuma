...
<p>What can you do with WebGL? Show us this month in the June Dev Derby!</p>"""),
    },
    {
        ...
        "learn_more": [],
        "tab_copy": _("""<p>Who needs JavaScript? The expanding capabilities of HTML and CSS mean that creating rich user experiences for the Web has never been easier. Mark Pilgrim captures this in his book <cite><a href="http://diveintohtml5.info/index.html">Dive into HTML5</a></cite>. "Scripting is here to stay, but should be avoided where more convenient declarative markup can be used." Today, declarative markup can be used to accomplish more than ever before.</p>
...
<p>What can you do without using JavaScript? Show us this month in the July Dev Derby!</p>"""),
    },
    {
    ...
    },
    {
        ...
        "summary": _("Geolocation lets you get the user's physical location. The Camera API lets you access their photographs easily. What can you do by combining the two?"),
        "description": _("Geolocation lets you get the user's physical location. The Camera API lets you access their photographs easily. What can you do by combining the two?"),
        "learn_more": [],
        "tab_copy": _("??"),
    },
