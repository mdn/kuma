...
class VersionGroupTests(TestCase):
    def test_version_groups(self):
        ...
        versions = [VersionMetadata(1, 'Firefox 4.0', 'fx4', 5.0, False),
                    VersionMetadata(2, 'Firefox 3.5-3.6', 'fx35', 4.0, False),
                    VersionMetadata(4, 'Firefox Mobile 1.1', 'm11', 2.0, False)]
