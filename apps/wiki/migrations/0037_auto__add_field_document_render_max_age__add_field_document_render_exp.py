...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Document.render_max_age'
        db.add_column('wiki_document', 'render_max_age',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Document.render_expires'
        db.add_column('wiki_document', 'render_expires',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Document.render_max_age'
        db.delete_column('wiki_document', 'render_max_age')

        # Deleting field 'Document.render_expires'
        db.delete_column('wiki_document', 'render_expires')
    ...
    models = {
        ...
        'wiki.document': {
            ...
            'render_expires': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'db_index': 'True'}),
