...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'WikiDocumentVisits'
        db.create_table('wiki_wikidocumentvisits', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('document', self.gf('django.db.models.fields.related.ForeignKey')(related_name='visits', to=orm['wiki.Document'])),
            ('period', self.gf('django.db.models.fields.IntegerField')()),
            ('visits', self.gf('django.db.models.fields.IntegerField')(db_index=True)),
        ))
        db.send_create_signal('wiki', ['WikiDocumentVisits'])

        # Adding unique constraint on 'WikiDocumentVisits', fields ['document', 'period']
        db.create_unique('wiki_wikidocumentvisits', ['document_id', 'period'])


    def backwards(self, orm):
        # Removing unique constraint on 'WikiDocumentVisits', fields ['document', 'period']
        db.delete_unique('wiki_wikidocumentvisits', ['document_id', 'period'])

        # Deleting model 'WikiDocumentVisits'
        db.delete_table('wiki_wikidocumentvisits')
    ...
    models = {
        ...
        'wiki.wikidocumentvisits': {
            'Meta': {'unique_together': "(('document', 'period'),)", 'object_name': 'WikiDocumentVisits'},
            'document': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'visits'", 'to': "orm['wiki.Document']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
