...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('wiki_document', 'mindtouch_page_id', self.gf('django.db.models.fields.IntegerField')(null=True, db_index=True), keep_default=False)

        # Adding field 'Document.modified'
        db.add_column('wiki_document', 'modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, db_index=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('wiki_document', 'modified')
