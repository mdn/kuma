...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Document.team'
        db.add_column('wiki_document', 'team', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['teamwork.Team'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Document.team'
        db.delete_column('wiki_document', 'team_id')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 7, 23, 13, 22, 42, 593107)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 7, 23, 13, 22, 42, 593002)'}),
