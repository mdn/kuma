...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('wiki_documenttag', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('slug', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=100, db_index=True)),
        ))
        db.send_create_signal('wiki', ['DocumentTag'])

        # Adding model 'TaggedDocument'
        db.create_table('wiki_taggeddocument', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('content_object', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['wiki.Document'])),
            ('tag', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['wiki.DocumentTag'])),
        ))
        db.send_create_signal('wiki', ['TaggedDocument'])


    def backwards(self, orm):
        
        # Deleting model 'DocumentTag'
        db.delete_table('wiki_documenttag')

        # Deleting model 'TaggedDocument'
        db.delete_table('wiki_taggeddocument')
