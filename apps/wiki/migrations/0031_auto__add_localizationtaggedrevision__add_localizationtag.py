...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'LocalizationTaggedRevision'
        db.create_table('wiki_localizationtaggedrevision', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('content_object', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['wiki.Revision'])),
            ('tag', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['wiki.LocalizationTag'])),
        ))
        db.send_create_signal('wiki', ['LocalizationTaggedRevision'])

        # Adding model 'LocalizationTag'
        db.create_table('wiki_localizationtag', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('slug', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=100)),
        ))
        db.send_create_signal('wiki', ['LocalizationTag'])


    def backwards(self, orm):
        # Deleting model 'LocalizationTaggedRevision'
        db.delete_table('wiki_localizationtaggedrevision')

        # Deleting model 'LocalizationTag'
        db.delete_table('wiki_localizationtag')
