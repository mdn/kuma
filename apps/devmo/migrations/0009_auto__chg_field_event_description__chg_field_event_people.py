...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('devmo_event', 'description', self.gf('django.db.models.fields.TextField')())

        # Changing field 'Event.people'
        db.alter_column('devmo_event', 'people', self.gf('django.db.models.fields.TextField')())


    def backwards(self, orm):
        
        # Changing field 'Event.description'
        db.alter_column('devmo_event', 'description', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'Event.people'
        db.alter_column('devmo_event', 'people', self.gf('django.db.models.fields.CharField')(max_length=255))
