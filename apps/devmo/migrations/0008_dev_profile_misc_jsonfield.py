...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.misc'
        db.add_column('user_profiles', 'misc', self.gf('jsonfield.JSONField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.misc'
        db.delete_column('user_profiles', 'misc')
