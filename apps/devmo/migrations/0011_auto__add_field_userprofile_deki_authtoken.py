...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.deki_authtoken'
        db.add_column('user_profiles', 'deki_authtoken', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.deki_authtoken'
        db.delete_column('user_profiles', 'deki_authtoken')
