...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('devmo_event', 'date', self.gf('django.db.models.fields.DateField')())


    def backwards(self, orm):
        
        # Changing field 'Event.date'
        db.alter_column('devmo_event', 'date', self.gf('django.db.models.fields.CharField')(max_length=255))
