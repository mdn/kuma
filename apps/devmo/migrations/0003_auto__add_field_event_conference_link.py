...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Event.conference_link'
        db.add_column('devmo_event', 'conference_link', self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Event.conference_link'
        db.delete_column('devmo_event', 'conference_link')
