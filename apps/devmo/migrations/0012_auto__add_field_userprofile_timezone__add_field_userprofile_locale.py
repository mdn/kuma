...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('user_profiles', 'timezone', self.gf('timezones.fields.TimeZoneField')(default='US/Pacific', null=True, blank=True), keep_default=False)

        # Adding field 'UserProfile.locale'
        db.add_column('user_profiles', 'locale', self.gf('sumo.models.LocaleField')(default='en-US', max_length=7, db_index=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.timezone'
        db.delete_column('user_profiles', 'timezone')

        # Deleting field 'UserProfile.locale'
        db.delete_column('user_profiles', 'locale')
