...
- ``default.txt`` - contains the default dependencies that are used during
  in all environments

- ``dev.txt`` - a file for development dependencies, for local development
  use only
...
safe of the dependency you added above::
