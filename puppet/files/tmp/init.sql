...
grant all privileges on *.* to kuma@'%' identified by 'kuma';
grant all privileges on *.* to kuma@localhost identified by 'kuma';
grant all privileges on *.* to kuma@10.0.2.15 identified by 'kuma';
flush privileges;
