...
class kuma_config {
    ...
    exec {
        "kuma_update_product_details":
            ...
            command => "/usr/bin/python2.6 ./manage.py update_product_details",
