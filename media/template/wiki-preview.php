...
head(
  $title = 'Previewing Article Title | MDN Docs',
  $pageid = '', 
...
<div class="wrap">
  ...
  <section id="content-main" class="full" role="main">
    <article class="article previewing" role="main">
    
      <header id="article-head">
        <div class="title">
          <h1>Previewing <em>Article Title</em></h1> 
        </div>
        ...
        <ul id="page-buttons">
          ...
          <li><button type="button" id="btn-preview" class="btn-preview" onclick="window.location.href='wiki-edit.php';">Back to Editing</button></li>
