...
;(function()
{
	...
	function Brush()
	{
		...
		var keywords =	'ascent azimuth background-attachment background-color background-image background-position ' +
				...
				'border-bottom-width border-left-width border-width border bottom box-shadow cap-height caption-side centerline clear clip color ' +
		...
		var values =	'above absolute all always aqua armenian attr aural auto avoid baseline behind below bidi-override black blink block blue bold bolder '+
				...
				'gray green groove handheld hebrew help hidden hide high higher icon inline-table inline inline-block inset inside invert italic '+
		...
		var units =	'px em pt rem ex ms s deg rad grad turn hz khz';
