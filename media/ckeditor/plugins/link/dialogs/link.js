...
CKEDITOR.dialog.add( 'link', function( editor )
{
	...
	{
		var dialog = this.getDialog(),
			partIds = [ 'urlOptions', 'anchorOptions', 'articleOptions', 'emailOptions' ],
                        ...
                        [
                            {
                                ...
                                commit: function(data)
                                {
                                    ...
                                    data.article.slug = this.getValue();
                                }
                            }
                        ]
                    },
		...
		onOk : function()
		{
			...
			switch ( data.type || 'url' )
			{
				...
				case 'anchor':
					...
					break;
                case "article":
                    attributes['data-cke-saved-href'] = '/docs/' + data.article.slug;
                    break;
				case 'email':
