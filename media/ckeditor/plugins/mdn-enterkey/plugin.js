...
(function()
{
    CKEDITOR.plugins.add( 'mdn-enterkey',
    {
    ...
    CKEDITOR.plugins.enterkey =
    {
        enterBlock : function( editor, mode, range, forceMode )
        {
            ...
            else
            {
                ...
                if(isStartOfBlock && splitInfo.wasEndOfBlock && previousBlock.is('dt')) {
                    var something = previousBlock.getParent();
                    newBlock = editor.document.createElement(blockTag);
                    previousBlock.remove().moveChildren(newBlock);
                    newBlock.insertAfter(something);
